...
export const CLUB_EVENTS: EventItem[] = [
  ...
  },
  {
    ...
    registeredCount: 18,
    speakers: [
      { name: 'فريق لجنة العلاقات والشراكات', title: 'النادي الهندسي' }
    ],
...
export const LIVE_ACTIVITY_STREAM = [
  ...
  { id: '3', title: 'إعداد خطة الورش التطبيقية', desc: 'لجنة العلاقات والشراكات تعكف على جدولة أولى الورش والشراكات التخصصية', time: 'مستمر', tag: 'TRAIN' },
