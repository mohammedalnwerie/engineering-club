...
export const COMMITTEES: CommitteeDefinition[] = [
  ...
  },
  {
    ...
    code: 'EVT',
    roles: ['مسؤول اللجنة', 'نائب مسؤول اللجنة', 'منسق أنشطة وبرامج', 'مسؤول تنظيم وميدان', 'مسؤول لوجستيات', 'عضو في اللجنة'],
  },
  {
    id: 'training',
    name: 'لجنة العلاقات والشراكات',
    code: 'REL',
    roles: ['مسؤول اللجنة', 'نائب مسؤول اللجنة', 'مسؤول علاقات وشراكات', 'منسق تدريب وتطوير', 'مسؤول تواصل واستقطاب', 'عضو في اللجنة'],
  },
  {
    id: 'media',
    name: 'لجنة الإعلام والاتصال',
    code: 'MED',
    roles: ['مسؤول اللجنة', 'نائب مسؤول اللجنة', 'مصمم جرافيك', 'مصور وموثق', 'صانع محتوى', 'مونتير فيديو', 'مسؤول منصات التواصل والاتصال', 'عضو في اللجنة'],
  },
];
