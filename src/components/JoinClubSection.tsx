...
export const JoinClubSection: React.FC = () => {
  ...
  const committees = [
    ...
    },
    {
      ...
      desc: 'فريق تخطيط وتنظيم المبادرات، الفعاليات، ورش العمل، والهاكاثونات الميدانية وإدارة البرامج.',
    ...
    },
    {
      ...
      desc: 'فريق بناء الشراكات المؤسسية، التواصل مع الشركات والنقابات، واستقطاب الرعايات والخبراء والمدربين.',
      badge: 'فريق تنظيمي (مقاعد محددة)',
    ...
    },
    {
      ...
      desc: 'فريق صناعة المحتوى الرقمي، التغطيات الحية، التصميم والمونتاج، والاتصال المؤسسي وإدارة المنصات.',
      badge: 'فريق تنظيمي (مقاعد محددة)',
