  ...
  const steps = [
    {
      ...
      description: 'الهندسة والتكنولوجيا الصناعية والبرمجيات، تكنولوجيا المعلومات، والهندسة المعمارية والمدنية. تكامل ثلاثي يجمع العتاد، البرمجيات، والبيئة العمرانية.',
      icon: Layers,
    ...
    },
    {
      ...
      description: 'هندسة البرمجيات، النظم الصناعية، علوم الحاسب والذكاء الاصطناعي، الأمن السيبراني، الهندسة المعمارية، والهندسة المدنية. مسارات متقاطعة تفتح آفاق الابتكار المتعدد.',
      icon: GitFork,
