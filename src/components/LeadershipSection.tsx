...
export const LeadershipSection: React.FC = () => {
  ...
  const tiers = [
    ...
    { label: 'الرئاسة والهيئة الإدارية', value: 'executive' },
    { label: 'رؤساء اللجان التنفيذية', value: 'committee-lead' },
  ];
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-16 gap-6">
          ...
          <p className="max-w-md text-sm sm:text-base text-gray-400 font-light">
            حوكمة مرنة ومسارات قرار واضحة تضمن انسيابية الأفكار من الرئاسة إلى الهيئة الإدارية واللجان التنفيذية.
          </p>
        </div>
        ...
        {activeTier === 'all' ? (
          <div className="flex flex-col items-center gap-10 relative">
            ...
            {/* LEVEL 2: EXECUTIVE BOARD (VICE PRESIDENT, SECRETARY, TREASURER) */}
            <div className="w-full max-w-5xl z-10">
              <div className="text-center font-mono text-[11px] text-blue-400 mb-3 uppercase tracking-wider">
                [LEVEL 02 // EXECUTIVE BOARD • الهيئة الإدارية التنفيذية]
              </div>
