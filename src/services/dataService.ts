...
export const DEFAULT_COMMITTEE_CRITERIA: CommitteeCriteriaSettings = {
  requirements: {
    training: [
      ...
      'العلاقات الخارجية والرعايات: امتلاك مهارات التواصل والتشبيك المهني مع الشركات الهندسية، النقابات، والمؤسسات الشريكة، واستقطاب الخبراء والمدربين المعتمدين لتنفيذ الورش وتأمين الرعايات.',
    ...
    media: [
      'التوثيق والتغطية الميدانية: امتلاك هاتف ذكي بكاميرا تصوير احترافية وعالية الدقة لتوثيق الفعاليات والورش أولاً بأول.',
      ...
      'الحس الفني وسرعة التسليم: امتلاك الرؤية الإبداعية والالتزام بسرعة فرز وتسليم التغطيات والمواد الإعلامية فور اختتام الفعالية دون تأخير.',
    ],
    events: [
      'الإدارة الميدانية والتنظيم: الحيوية والقدرة على إدارة الحشود وتوجيه الطلبة وتنظيم القاعات والمنصات والتجهيزات التقنية والصوتية.',
      'العمل بروح الفريق تحت الضغط: الجاهزية اللوجستية والمرونة في التعامل مع المتغيرات الطارئة أثناء الفعاليات والهاكاثونات الكبرى.',
      'الالتزام بالحضور الميداني: التواجد المسبق للتحضير قبل انطلاق الفعالية والاستمرار الميداني حتى إتمامها وترتيب الموقع بالكامل.',
    ],
  },
